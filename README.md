...
<h3 align="center">Jr. SWE- Backend @Affpilot || Golang || Python || Gin || FastAPI || Docker || RabbitMQ || Redis|| PostgreSql || ICPC Dhaka Regionalist || Cricket Columnist @The Roar</h3>
